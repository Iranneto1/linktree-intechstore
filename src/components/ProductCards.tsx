    ...
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      >
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Grid Inferior de Cards Menores - Alinhados com a direita */}
          <div className="grid md:grid-cols-3 gap-6">
            <motion.div
              variants={cardVariants}
              whileHover="hover"
              className="h-74 bg-blue-600 rounded-[32px] p-6 text-white flex flex-col justify-center items-center text-center shadow-lg"
            >
            ...
            <motion.div
              variants={cardVariants}
              whileHover="hover"
              className="h-74 bg-white/40 backdrop-blur-md rounded-[32px] overflow-hidden border border-white/20 relative group"
            >
              <ImageWithFallback
        ...
        <div className="space-y-6">
          ...
          {/* Card Lateral Grande (Pagamentos) */}
          <motion.div
            variants={cardVariants}
            whileHover="hover"
