      ...
      >
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <motion.div
              variants={cardVariants}
              whileHover="hover"
              className="h-72 bg-white/40 backdrop-blur-md rounded-[32px] overflow-hidden border border-white/20 relative group"
            >
              <ImageWithFallback
        ...
        <div className="space-y-6">
          ...
          <motion.div
            variants={cardVariants}
            whileHover="hover"
            className="h-[660px] bg-white/40 backdrop-blur-md rounded-[40px] overflow-hidden border border-white/20 relative group cursor-pointer shadow-xl"
          >
            <ImageWithFallback
              src="https://res.cloudinary.com/dpnlypvpc/image/upload/v1770375688/Pagamentos_xpy0bi.png"
              alt="Pagamentos"
